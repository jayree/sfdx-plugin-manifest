...
exports.buildManifestComponentSet =
  exports.getGitResults =
  exports.getGitDiff =
  exports.analyzeFile =
  exports.createVirtualTreeContainer =
  exports.ensureGitPath =
  exports.ensureOSPath =
  exports.debug =
  exports.NodeFSTreeContainer =
    void 0;
  ...
  for (const path of paths) {
    ...
    while (dirOrFilePath !== (0, path_1.dirname)(dirOrFilePath)) {
      ...
      if (path.endsWith(fileOrFolderName)) {
        const data =
          (0, utils_1.parseMetadataXml)(path) && modifiedFiles.includes(path)
            ? Buffer.from(
                (
                  await isomorphic_git_1.default.readBlob({
                    fs,
                    dir,
...
async function getFileStateChanges(commitHash1, commitHash2, dir) {
  ...
  return isomorphic_git_1.default.walk({
    ...
    dir,
    trees: [
      isomorphic_git_1.default.TREE({ ref: commitHash1 }),
      commitHash2 ? isomorphic_git_1.default.TREE({ ref: commitHash2 }) : isomorphic_git_1.default.STAGE(),
    ],
    async map(filepath, [A, B]) {
      if (
        filepath === '.' ||
        (await (A === null || A === void 0 ? void 0 : A.type())) === 'tree' ||
        (await (B === null || B === void 0 ? void 0 : B.type())) === 'tree'
      ) {
        return;
      }
