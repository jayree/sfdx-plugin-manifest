...
function fixComponentSetChilds(cs) {
    ...
    const childsTobeReplacedByParent = [
        ...
        ...Object.keys(source_deploy_retrieve_1.registry.types.customobjecttranslation.children.types),
        ...Object.keys(source_deploy_retrieve_1.registry.types.bot.children.types),
        ...Object.keys(source_deploy_retrieve_1.registry.types.datamappingobjectdefinition.children.types),
    ];
    ...
    return new source_deploy_retrieve_1.ComponentSet(sourceComponents, registryAccess);
}
