...
const getSequential = ({ packageDirs, adds, modifies, deletes }) => {
...
export const getComponentSets = ({ groupings, sourceApiVersion, registry, resolverForNonDeletes, resolverForDeletes, virtualTreeContainer, }) => {
