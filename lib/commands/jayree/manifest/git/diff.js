...
import { getGitResults, createVirtualTreeContainer, fixComponentSetChilds, getGitDiff, debug, getGitArgsFromArgv, } from '../../../../utils/gitdiff.js';
    ...
    async run() {
        ...
        const tasks = new Listr([
            ...
            },
            {
                ...
                task: async (ctx, task) => {
                    const { gitlines, warnings } = await getGitDiff(this.sfdxProjectFolders, gitArgs.ref1, gitArgs.ref2, this.projectRoot);
