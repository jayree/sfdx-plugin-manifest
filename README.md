...
_See code: [src/commands/jayree/manifest/cleanup.ts](https://github.com/jayree/sfdx-plugin-manifest/blob/4.0.124/src/commands/jayree/manifest/cleanup.ts)_
...
_See code: [src/commands/jayree/manifest/generate.ts](https://github.com/jayree/sfdx-plugin-manifest/blob/4.0.124/src/commands/jayree/manifest/generate.ts)_
...
_See code: [src/commands/jayree/manifest/git/diff.ts](https://github.com/jayree/sfdx-plugin-manifest/blob/4.0.124/src/commands/jayree/manifest/git/diff.ts)_
<!-- commandsstop -->
