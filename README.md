...
running command...
$ sfdx plugins
@jayree/sfdx-plugin-manifest 2.1.7
...
_See code: [commands/jayree/manifest/cleanup.ts](https://github.com/jayree/sfdx-plugin-manifest/blob/v2.1.7/commands/jayree/manifest/cleanup.ts)_
...
_See code: [commands/jayree/manifest/generate.ts](https://github.com/jayree/sfdx-plugin-manifest/blob/v2.1.7/commands/jayree/manifest/generate.ts)_
...
_See code: [commands/jayree/manifest/git/diff.ts](https://github.com/jayree/sfdx-plugin-manifest/blob/v2.1.7/commands/jayree/manifest/git/diff.ts)_
<!-- commandsstop -->
