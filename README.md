...
_See code: [src/commands/jayree/manifest/cleanup.ts](https://github.com/jayree/sfdx-plugin-manifest/blob/5.0.144/src/commands/jayree/manifest/cleanup.ts)_
...
_See code: [src/commands/jayree/manifest/generate.ts](https://github.com/jayree/sfdx-plugin-manifest/blob/5.0.144/src/commands/jayree/manifest/generate.ts)_
...
_See code: [src/commands/jayree/manifest/git/diff.ts](https://github.com/jayree/sfdx-plugin-manifest/blob/5.0.144/src/commands/jayree/manifest/git/diff.ts)_
<!-- commandsstop -->
