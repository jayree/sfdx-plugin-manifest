...
describe('getLogMessage', () => {
  it('formats full and modified move matches', () => {
    ...
    assert.deepEqual(messages, [
      'The file force-app/classes/Old.cls moved to force-app/classes/New.cls was ignored.',
      'The file force-app/classes/Original.cls moved to force-app/classes/Changed.cls and modified was processed.',
    ]);
  });
});
